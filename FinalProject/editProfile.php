...
<header>
    ...
    <div id="wrapper">
        ...
        <form method="get" action="save_profile.php">

            <p>First Name: <input type="text"class ="form-control" name="firstname" placeholder="my name" value="<?php echo $row["first_name"]; ?>"></p>
            <p>Last Name: <input type="text" class ="form-control" name="lastname" placeholder="My password" value="<?php echo $row ["last_name"];?>"></p>
            <p>Email: <input type="email" class ="form-control" name="mail" placeholder="My Email" value="<?php echo $row ["email"];?>"></p>
            <div class="button">
