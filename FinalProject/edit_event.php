<?php
    ...
    $query = 'SELECT * FROM tbl_202_events WHERE event_id=' . $event_id;
	...
	if($result) {
        ...
        header('Location: ' . URL . 'event.php?event_id='. $event_id .'');
    }
?>
        ...
        <div class="contain">
            ...
            <form class="form_align" action="save_event.php" method="get">
                    <div class="col-5">
                        ...
                        <select name="event_type" class="form-select cat" id="type" required data-selected="<?php echo $row["event_type"];?>">
                    ...
                    <div class="col-5">
                        ...
                        <input type="text" name="commander" placeholder="Commander's name" class="form-control" value="<?php echo $row["crew"];?>">                     
                    </div>
                    ...
                    <div class="col-5">
                        ...
                        <select name="building_type" class="form-select" id="btype" aria-label="Default select example" data-selected="<?php echo $row["building_type"];?>">
                    ...
                    <div class="col-5">
                        ...
                        <select name="urgency" class="form-select" id="urg" aria-label="Default select example">
                            <option selected disabled>select</option>
                    ...
                    <div class="col-5">
                            <label class="col-sm-4 col-form-label hazard">
                                Hazardous material<br>
                            </label>


                            <select required name="hazard" class="form-select" id="haz" aria-label="Default select example" data-selected="<?php echo $row["hazardous"];?>">
                                <option selected disabled>select</option>
